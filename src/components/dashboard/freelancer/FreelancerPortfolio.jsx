...
const FreelancerPortfolio = ({ profile, addNotification, setHasUnsavedChanges, triggerTremble, fetchProfile }) => {
  ...
  return (
    <div className={'layout-bottom flex-1 minh-0 flex-col pos-relative mx-auto portfolio-wrapper' + (isPremium && !isEditing ? ' premium-card' : '')} style={{ maxWidth: '800px', width: '100%' }}>
