...
const FreelancerPortfolio = ({ profile, addNotification, setHasUnsavedChanges, triggerTremble, fetchProfile }) => {
  ...
  return (
    <div className={'layout-bottom flex-1 minh-0 flex-col pos-relative mx-auto' + (isPremium && !isEditing ? ' premium-card' : '')} style={{ maxWidth: '800px', width: '100%', minHeight: '400px', maxHeight: 'calc(100vh - 180px)' }}>
